...
js/bfrb-risk.js                 — BFRB Closed Loop Slice B: pure `BfrbRisk.assess()` — decides clustered vs steady vs suppressed from the live stream + (optional) recovery row. Suppression guards mirror Tempo Coach. Zero DOM/copy; owns the ratified gentle pace-support nudge decision only.
